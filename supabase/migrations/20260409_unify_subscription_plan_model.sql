-- Migration: Unify legacy scoped subscription plans into a single plan catalog
-- Date: 2026-04-09
-- Purpose: Align existing databases with the unified free/basic/pro/enterprise subscription model
...
COMMENT ON TABLE public.subscription_plan_catalog IS 'Backend-configurable unified subscription pricing, resources, and plan constraints';
...
COMMENT ON COLUMN public.subscription_plan_catalog.resources IS 'JSON array of unified resource definitions for organization and AI limits';
